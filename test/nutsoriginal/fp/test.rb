...
class Nutsoriginal::FpTest < Minitest::Test
  ...
  def test_rating
    ...
    result = Nutsoriginal::Fp.rating(array)
  ...
  def test_chars_count
    ...
    result = Nutsoriginal::Fp.chars_count(array, 5)
    assert result == 891

    result = Nutsoriginal::Fp.chars_count(array, 8.5)
    assert result == 1
  end
end
