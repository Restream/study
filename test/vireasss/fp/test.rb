...
class Vireasss::FpTest < Minitest::Test
  ...
  def test_countries_count
    ...
    assert result == {
      "США" => 147, "Великобритания" => 43, "Россия" => 57, "Канада" => 31,
      "Франция" => 6, "Бельгия" => 1, "Австралия" => 2, "Германия" => 6,
      "Тайвань" => 1, "ЮАР" => 3, "Индия" => 2, "Дания" => 2, "Швеция" => 2,
      "НоваяЗеландия" => 2, "Италия" => 27, "Украина" => 1, "ЮжнаяКорея" => 2
    }

    result = Vireasss::Fp.countries_count(array, 2001)
    assert result == {
      "Испания" => 13, "США" => 33, "Великобритания" => 4, "Германия" => 8,
      "Ирландия" => 1, "Россия" => 3, "Австралия" => 2, "Канада" => 1,
      "НоваяЗеландия" => 1, "Италия" => 1, "Франция" => 3
    }
  end
end
