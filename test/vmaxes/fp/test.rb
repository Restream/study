...
class Vmaxes::FpTest < Minitest::Test
  ...
  def test_countries_count
    ...
    assert result == {
      "Канада" => 3, "США" => 42, "Россия" => 5, "Великобритания" => 5, "Германия" => 7,
      "Испания" => 2, "Италия" => 1, "НоваяЗеландия" => 1, "Австралия" => 2, "Франция" => 2,
      "Япония" => 1
    }

    result = Vmaxes::Fp.countries_count(array, 2001)
    assert result == {
      "Испания" => 13, "США" => 33, "Великобритания" => 4, "Германия" => 8, "Ирландия" => 1,
      "Россия" => 3, "Австралия" => 2, "Канада" => 1, "НоваяЗеландия" => 1, "Италия" => 1, "Франция" => 3
    }
  end
end
